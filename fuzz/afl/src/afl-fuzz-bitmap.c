...
/////////////////////////////////////////////////////////////////////////////////////////////////
void write_coverage_diff(afl_state_t *afl) {
  
    int fd;
    u8* covfn = alloc_printf("%s/.cov_diff", afl->out_dir);
...
/////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      fn = alloc_printf("%s/hangs/id:%06llu,%s", afl->out_dir,
                        afl->saved_hangs, describe_op(afl, 0, NAME_MAX - strlen("id:000000,")));
/////////////////////////////////////////////////////////////////////////////////////////////////
#else
...
/////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      // }
      fn = alloc_printf("%s/crashes/id:%06llu_sig:%02u_%s.js", afl->out_dir,afl->saved_crashes, afl->fsrv.last_kill_signal, describe_op(afl, 0, NAME_MAX - strlen("id:000000,sig:00,")));
/////////////////////////////////////////////////////////////////////////////////////////////////
#else
...
/////////////////////////////////////////////////////////////////////////////////////////////////
  if (fault == FSRV_RUN_CRASH) {
    ...
    if (afl->own_loc == NULL) FATAL("afl->own_loc is NULL??");
    cmdline = alloc_printf("node %s/../TS/redis_ctrl.js"
        " insertCrash %s %s/.cov_diff",
        afl->own_loc, afl->current_fn, afl->out_dir);
